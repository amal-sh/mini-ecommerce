    ...
    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden mt-8">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-8 flex flex-col justify-center">
          ...
          <button 
            onClick={addToCart}
            className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-4 px-8 rounded-xl transition-all transform active:scale-[0.98] shadow-md hover:shadow-lg flex justify-center items-center gap-2"
          >
